...
from pokepay.response.account_transfer_summary import AccountTransferSummary


class GetAccountTransferSummary(PokepayRequest):
    def __init__(self, account_id, **rest_args):
        self.path = "/accounts" + "/" + account_id + "/transfers" + "/summary"
        self.method = "GET"
        self.body_params = {}
