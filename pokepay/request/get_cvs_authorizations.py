...
from pokepay.response.paginated_cvs_authorizations import PaginatedCvsAuthorizations


class GetCvsAuthorizations(PokepayRequest):
    def __init__(self, private_money_id, **rest_args):
        ...
        self.response_class = PaginatedCvsAuthorizations
