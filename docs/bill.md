...
response = client.send(pp.ListBills(
                          page=9989,                                            # ページ番号
                          per_page=9510,                                        # 1ページの表示数
                          bill_id="yLhmVZrKtr",                                 # 支払いQRコードのID
                          private_money_id="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", # マネーID
                          organization_code="Aa02-8--c-c-4lBW9-8ds58--PmuIrC9", # 組織コード
                          description="test bill",                              # 取引説明文
                          created_from="2023-06-18T15:42:21.000000Z",           # 作成日時(起点)
                          created_to="2023-03-26T14:35:12.000000Z",             # 作成日時(終点)
                          shop_name="bill test shop1",                          # 店舗名
                          shop_id="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",       # 店舗ID
                          lower_limit_amount=7156,                              # 金額の範囲によるフィルタ(下限)
                          upper_limit_amount=8581,                              # 金額の範囲によるフィルタ(上限)
